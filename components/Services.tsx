...
export const Services: React.FC = () => {
  ...
  const [selectedService, setSelectedService] = useState<'diagnostic' | 'partner' | undefined>();

  const openBooking = (type: 'diagnostic' | 'partner') => {
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="glass-panel rounded-3xl p-10 border border-white/10 hover:border-brand-accent/30 transition-all duration-500 group relative">
          <div className="mb-8">
            ...
            <div className="flex flex-col">
              <span className="text-sm text-gray-500 line-through font-medium">Was £266.65</span>
          ...
          <Button variant="outline" className="w-full justify-between" onClick={() => openBooking('diagnostic')}>
            Book Now
        ...
        <div className="bg-gradient-to-b from-brand-card to-brand-dark rounded-3xl p-10 border border-brand-accent/50 shadow-[0_0_40px_rgba(217,70,239,0.1)] relative group">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col">
              <span className="text-sm text-gray-500 line-through font-medium">Was £1,249.98</span>
              <div className="flex items-baseline gap-2">
                <div className="flex flex-col">
                   <span className="text-5xl font-bold text-brand-accent">£749.99</span>
                   <span className="text-[10px] text-brand-accent/60 font-black uppercase tracking-widest">Per Month</span>
                </div>
          ...
          <Button className="w-full justify-between bg-brand-accent text-white" onClick={() => openBooking('partner')}>
            Join Programme
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Button>
        </div>
